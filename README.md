...
| | What it does | Stack |
|-|-------------|-------|
| [GhostFund](https://github.com/dmustapha/ghostfund) | **Winner — Chainlink Convergence 2026.** Private DeFi yield vault combining CRE, Private Transactions, and ACE | Solidity, TypeScript, Foundry, Chainlink, Aave V3 |
| [DeepRock](https://github.com/dmustapha/deeprock) | On-chain RWA investment pools: treasury bills, private credit, real estate on Avalanche | Next.js, Solidity, ERC-4337, WebAuthn |
